...
-- SmartLib Ubhara - Database Reset Script
-- ============================================
-- Script ini akan menghapus SEMUA data dan reset ke kondisi awal
-- dengan hanya 2 users (admin & member) dan 20 buku stok 5
-- ============================================

-- STEP 1: Hapus semua data dari semua tabel
-- ============================================
-- PENTING: Urutan penghapusan harus sesuai foreign key constraints!

-- 1. Hapus activities terlebih dahulu (referensi ke users & borrowings)
DELETE FROM activities;

-- 2. Hapus borrowings (referensi ke users & books)
DELETE FROM borrowings;

-- 3. Hapus users (akan di-seed ulang)
DELETE FROM users;

-- 4. Hapus books (akan di-seed ulang)
DELETE FROM books;
...
-- ============================================
-- STEP 2: Reset Sequences (jika ada)
-- ============================================
-- Ini untuk memastikan ID auto-increment mulai dari awal

-- Reset sequence jika menggunakan serial/auto-increment
-- ALTER SEQUENCE IF EXISTS books_id_seq RESTART WITH 1;
-- ALTER SEQUENCE IF EXISTS users_id_seq RESTART WITH 1;
-- ALTER SEQUENCE IF EXISTS borrowings_id_seq RESTART WITH 1;

-- ============================================
-- STEP 3: Insert Data Bersih dari Seed
-- ============================================
...
-- Expected Result:
-- total_books: 20 (semua dengan stok 5)
-- total_users: 2 (admin dan budi)
-- total_borrowings: 0 (tidak ada peminjaman)
-- total_activities: 0 (tidak ada log aktivitas)
